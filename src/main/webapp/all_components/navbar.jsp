...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
	<a class="navbar-brand" href="#">JOB.com</a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<form class="form-inline my-2 my-lg-0">
			<c:if test="${userobj.role eq 'admin'}">
				...
				<a href="logout" class="btn btn-light"><i class="fa-solid fa-arrow-right-to-bracket"></i> Logout</a>
			</c:if>
			...
			<c:if test="${ empty userobj }">
				<a href="login.jsp" class="btn btn-light mr-1"><i class="fa-solid fa-arrow-right-to-bracket"></i> Login</a>
